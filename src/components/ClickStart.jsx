    ...
    <section className=" relative -mt-[5%] sm:-mt-[1%]">
        <div className=" mx-auto  justify-center mt-5 mb-2  flex">
            <a
              ...
              className="  tracking-[-0.11em] uppercase archo-black text-4xl sm:text-7xl  py-2 px-4 sm:px-6   bg-[#fbe000] border-2 border-[#94339d]   mx-auto btn-hov rounded-xl  text-[#94339d]"
            >
              {" "}
              Play <span>Now</span>
