    ...
    <section className=" relative  h-[100vh]  ">
      <div className="container-wrapper relative z-50 flex items-center flex-col ">
        ...
        <img
          src="images/winn.png"
          alt=""
          className=" absolute right-3 sm:right-[23%] h-[80px] sm:h-[125px] top-[81%] sm:top-[73%]"
        />

        <img
          src="images/grand.png"
          alt=""
          className=" absolute right-3 sm:right-[23%] h-[70px] sm:h-[110px] -bottom-5 sm:-bottom-[21px] overflow-y-hidden"
        />
        <img
